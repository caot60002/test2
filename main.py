...
if not os.path.exists("ToiLaTu"):
    os.makedirs("ToiLaTu", exist_ok=True)
SERVER_LINKS_FILE = "ToiLaTu/server-links.txt"
ACCOUNTS_FILE = "ToiLaTu/accounts.txt"
CONFIG_FILE = "ToiLaTu/config.json"

version = "2.2.5 | Customized by ToiLaTu"
...
class FileManager:
    SERVER_LINKS_FILE = "ToiLaTu/server-link.txt"
    ACCOUNTS_FILE = "ToiLaTu/account.txt"
    CONFIG_FILE = "ToiLaTu/config-wh.json"
    ...
    def save_server_links(server_links):
        try:
            ...
            print("\033[1;32m[ ToiLaTu ] - Server links saved successfully.\033[0m")
        except IOError as e:
            print(f"\033[1;31m[ ToiLaTu ] - Error saving server links: {e}\033[0m")
                ...
                for line in file:
                    ...
                    if line:
                        try:
                            ...
                            print(f"\033[1;31m[ ToiLaTu ] - Invalid line format: {line}. Expected format 'package,user_id'.\033[0m")
        return accounts
    ...
    def find_userid_from_file(file_path):
        try:
            with open(file_path, 'r') as file:
                ...
                if userid_start == -1:
                    print("\033[1;31m[ ToiLaTu ] - Userid not found\033[0m")
                    return None

                userid_start += len('"UserId":"')
                userid_end = content.find('"', userid_start)
                if userid_end == -1:
                    print("\033[1;31m[ ToiLaTu ] - Userid end quote not found\033[0m")
                    return None
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error reading file: {e}\033[0m")
            return None
    ...
    def get_username(user_id):
        ...
        for attempt in range(retry_attempts):
            try:
                ...
                print(f"\033[1;31m[ ToiLaTu ] - Attempt {attempt + 1} failed for Roblox Users API: {e}\033[0m")
        ...
        for attempt in range(retry_attempts):
            try:
                ...
                print(f"\033[1;31m[ ToiLaTu ] - Attempt {attempt + 1} failed for RoProxy API: {e}\033[0m")
                time.sleep(2 ** attempt)
    ...
    def save_username(user_id, username):
        try:
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error saving username: {e}\033[0m")
    ...
    def load_saved_username(user_id):
        try:
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error loading username: {e}\033[0m")
            return None
    ...
    def download_file(url, destination, binary=False):
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"\033[1;32m[ ToiLaTu ] - {os.path.basename(destination)} downloaded successfully.\033[0m")
                return destination
            else:
                error_message = f"Failed to download {os.path.basename(destination)}. Status code: {response.status_code}"
                print(f"\033[1;31m[ ToiLaTu ] - {error_message}\033[0m")
    ...
    def _load_config():
        ...
        try:
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error loading configuration: {e}\033[0m")
    ...
    def save_config():
        ...
        try:
            ...
            print("\033[1;32m[ ToiLaTu ] - Configuration saved successfully.\033[0m")
        except Exception as e:
            print(f"\033[1;31m[ ToiLaTu ] - Error saving configuration: {e}\033[0m")
...
class SystemMonitor:
    ...
    def capture_screenshot():
        ...
        try:
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error capturing screenshot: {e}\033[0m")
    ...
    def get_memory_usage():
        try:
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error getting memory usage: {e}\033[0m")
    ...
    def get_system_info():
        try:
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error retrieving system information: {e}\033[0m")
...
class RobloxManager:
    ...
    def get_cookie():
        try:
            ...
            new_dir_path = os.path.join(current_dir, "ToiLaTu/Shoụko.dev - Data")
            ...
            if not os.path.exists(cookie_txt_path):
                print("\033[1;31m[ ToiLaTu ] - cookie.txt not found in the current directory!\033[0m")
            ...
            if len(cookies) == 0:
                print("\033[1;31m[ ToiLaTu ] - No valid cookies found in cookie.txt. Please add cookies.\033[0m")
            ...
            print(f"\033[1;31m[ ToiLaTu ] - Error: {e}\033[0m")
    ...
    def verify_cookie(cookie_value):
        try:
            ...
            if response.status_code == 200:
                print("\033[1;32m[ ToiLaTu ] - Cookie is valid! User is authenticated.\033[0m")
                return response.json().get("id", False)
            elif response.status_code == 401:
                print("\033[1;31m[ ToiLaTu ] - Invalid cookie. The user is not authenticated.\033[0m")
                return False
            else:
    ...
    def get_roblox_packages():
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print(f"\033[1;31m[ ToiLaTu ] - Failed to retrieve packages with prefix {package_prefix}.\033[0m")
                Utilities.log_error(f"Failed to retrieve packages with prefix {package_prefix}. Return code: {result.returncode}")
        except Exception as e:
            print(f"\033[1;31m[ ToiLaTu ] - Error retrieving packages: {e}\033[0m")
    ...
    def kill_roblox_process(package_name):
        print(f"\033[1;96m[ ToiLaTu ] - Killing Roblox process for {package_name}...\033[0m")
        try:
            subprocess.run(
            ...
            print(f"\033[1;32m[ ToiLaTu ] - Killed process for {package_name}\033[0m")
            time.sleep(2)
        except subprocess.CalledProcessError as e:
            print(f"\033[1;31m[ ToiLaTu ] - Error killing process for {package_name}: {e}\033[0m")
    ...
    def delete_cache_for_package(package_name):
        ...
        if os.path.exists(cache_path):
            ...
            print(f"\033[1;32m[ ToiLaTu ] - Cache cleared for {package_name}\033[0m")
        else:
            print(f"\033[1;93m[ ToiLaTu ] - No cache found for {package_name}\033[0m")
    ...
    def inject_cookies_and_appstorage():
        ...
        db_url = "https://github.com/caot60002/t/raw/refs/heads/main/Cookies"
        appstorage_url = "https://raw.githubusercontent.com/caot60002/t/refs/heads/main/appStorage.json"
        ...
        if not downloaded_db_path or not downloaded_appstorage_path:
            print("\033[1;31m[ ToiLaTu ] - Failed to download necessary files. Exiting.\033[0m")
            Utilities.log_error("Failed to download necessary files for cookie and appStorage injection.")
            return

        packages = RobloxManager.get_roblox_packages()
        if not packages:
            print("\033[1;31m[ ToiLaTu ] - No Roblox packages detected.\033[0m")
            return
        ...
        for package_name in packages:
            try:
                ...
                if not cookie:
                    print(f"\033[1;31m[ ToiLaTu ] - Failed to retrieve a cookie for {package_name}. Skipping...\033[0m")
                    break

                user_id = RobloxManager.verify_cookie(cookie)
                if user_id:
                    print(f"\033[1;32m[ ToiLaTu ] - Cookie for {package_name} is valid! User ID: {user_id}\033[0m")
                else:
                    print(f"\033[1;31m[ ToiLaTu ] - Cookie for {package_name} is invalid. Skipping injection...\033[0m")
                    continue

                print(f"\033[1;32m[ ToiLaTu ] - Injecting cookie for {package_name}: {cookie}\033[0m")
                ...
                print(f"\033[1;32m[ ToiLaTu ] - Copied Cookies.db to {destination_db_path}\033[0m")
                ...
                print(f"\033[1;32m[ ToiLaTu ] - Copied appStorage.json to {destination_appstorage_path}\033[0m")
        ...
        print("\033[1;32m[ ToiLaTu ] - Opening all Roblox tabs...\033[0m")
        failed_packages = []
        for package_name in packages:
            try:
                print(f"\033[1;36m[ ToiLaTu ] - Launching {package_name}...\033[0m")
                cmd_splash = [
                    'am', 'start',
                    '-a', 'android.intent.action.MAIN',
                    '-n', f'{package_name}/com.roblox.client.startup.ActivitySplash'
                ...
                if result_splash.returncode != 0:
                    ...
                    print(f"\033[1;32m[ ToiLaTu ] - Successfully launched {package_name}\033[0m")
            except Exception as e:
        ...
        if failed_packages:
            print(f"\033[1;31m[ ToiLaTu ] - Failed to launch packages: {', '.join(failed_packages)}\033[0m")
        else:
            print("\033[1;32m[ ToiLaTu ] - Successfully launched all packages.\033[0m")

        print("\033[1;33m[ ToiLaTu ] - Waiting for all tabs to load (1 minute)...\033[0m")
        time.sleep(60)

        debug_mode = input("\033[1;93m[ ToiLaTu ] - Keep Roblox tabs open for debugging? (y/n): \033[0m").strip().lower()
        if debug_mode != 'y':
            print("\033[1;33m[ ToiLaTu ] - Closing all Roblox tabs after loading...\033[0m")
            RobloxManager.kill_roblox_processes()
            time.sleep(5)
        else:
            print("\033[1;33m[ ToiLaTu ] - Keeping Roblox tabs open for debugging.\033[0m")

        print("\033[1;32m[ ToiLaTu ] - Cookie and appStorage injection, followed by app launch, completed for all packages.\033[0m")
    ...
    def format_server_link(input_link):
        if 'roblox.com' in input_link:
            ...
            print("\033[1;31m[ ToiLaTu ] - Invalid input! Please enter a valid game ID or private server link.\033[0m")
            return None
...
class WebhookManager:
        ...
        while not stop_webhook_thread:
            try:
                ...
                embed = {
                    ...
                    "footer": {"text": f"Made with 💖 by ToiLaTu | Join us at discord.gg/BZ3UYgjUJk",
                ...
                with open(screenshot_path, "rb") as file:
                    response = requests.post(
                        webhook_url,
                        data={"payload_json": json.dumps({"embeds": [embed], "username": "ToiLaTu", "avatar_url": "https://i.imgur.com/5yXNxU4.png"})},
                        files={"file": ("screenshot.png", file)}
                    )

                if response.status_code not in (200, 204):
                    print(f"\033[1;31m[ ToiLaTu ] - Error sending device info: {response.status_code}\033[0m")
                    Utilities.log_error(f"Error sending webhook: Status code {response.status_code}")

            except Exception as e:
                print(f"\033[1;31m[ ToiLaTu ] - Webhook error: {e}\033[0m")
    ...
    def setup_webhook():
        ...
        try:
            stop_webhook_thread = True
            webhook_url = input("\033[1;35m[ ToiLaTu ] - Enter your Webhook URL: \033[0m")
            device_name = input("\033[1;35m[ ToiLaTu ] - Enter your device name: \033[0m")
            webhook_interval = int(input("\033[1;35m[ ToiLaTu ] - Enter the interval to send Webhook (minutes): \033[0m"))
            FileManager.save_config()
            stop_webhook_thread = False
            threading.Thread(target=WebhookManager.send_webhook).start()
        except Exception as e:
            print(f"\033[1;31m[ ToiLaTu ] - Error during webhook setup: {e}\033[0m")
 ...
 \$$$$$$$$______   \$$| $$       ______\$$$$$$$$__    __ 
   ...
   | $$  \$$    $$| $$| $$     \\$$    $$| $$   \$$    $$
    \$$   \$$$$$$  \$$ \$$$$$$$$ \$$$$$$$ \$$    \$$$$$$ 
        ...
        config_file = os.path.join("ToiLaTu", "config.json")
        check_executor = "1"
        global codex_bypass_enabled
        ...
        if os.path.exists(config_file):
            try:
                ...
                console.print(f"[bold red][ ToiLaTu ] - Error reading {config_file}: {e}[/bold red]")

        console.print(header)
        console.print(f"[bold yellow]- Version: [/bold yellow][bold white]{version}[/bold white]")
        console.print(f"[bold yellow]- Credit: [/bold yellow][bold white]ToiLaTu[/bold white]")
...
class ExecutorManager:
        ...
        for executor_name, base_path in executors.items():
            ...
            for path in possible_autoexec_paths:
                if os.path.exists(path):
                    ...
                    console.print(f"[bold green][ ToiLaTu ] - Detected executor: {executor_name}[/bold green]")
                    break
    ...
    def write_lua_script(detected_executors):
        console = Console()
        config_file = os.path.join("ToiLaTu", "checkui.lua")

        try:
            with open(config_file, "r") as f:
                lua_script_content = f.read()
        except Exception as e:
            console.print(f"[bold red][ ToiLaTu ] - Error reading config from {config_file}: {e}[/bold red]")
            return
            ...
            if executor_name.upper() == "KRNL":
                ...
                if "check_executor" not in autoruns_data:
                    ...
                    try:
                        ...
                        console.print(f"[bold green][ ToiLaTu ] - Added script into KRNL autoexec![/bold green]")
                    except Exception as e:
                        console.print(f"[bold red][ ToiLaTu ] - Error updating KRNL autoexec: {e}[/bold red]")
                        Utilities.log_error(f"Error updating KRNL autoexec: {e}")
                else:
                    console.print(f"[bold green][ ToiLaTu ] - Script already exists in KRNL autoexec![/bold green]")
                ...
                try:
                    ...
                    lua_written = True
                    console.print(f"[bold green][ ToiLaTu ] - Lua script written successfully![/bold green]")
                except Exception as e:
                    console.print(f"[bold red][ ToiLaTu ] - Error writing Lua script to KRNL autoexec: {e}[/bold red]")
            ...
            if not lua_written:
                if executor_name.upper() == "DELTA":
                    ...
                    try:
                        ...
                        lua_written = True
                        console.print(f"[bold green][ ToiLaTu ] - Lua script written to: {lua_script_path}[/bold green]")
                    except Exception as e:
                        console.print(f"[bold red][ ToiLaTu ] - Error writing Lua script to {lua_script_path}: {e}[/bold red]")
            ...
            while True:
                ...
                try:
                    ...
                    if not executor_loaded:
                        ...
                        time.sleep(15)
                        print(f"\033[1;33m[ToiLaTu] - Rejoining {package_name}...\033[0m")
                    ...
                    RobloxManager.delete_cache_for_package(package_name)
                    time.sleep(10)
                    print(f"\033[1;33m[ToiLaTu] - Rejoining {package_name} after error...\033[0m")
                    globals()["package_statuses"][package_name]["Status"] = "\033[1;36mRejoining\033[0m"
                    UIManager.update_status_table()
                    RobloxManager.launch_roblox(package_name, server_link)
                    globals()["package_statuses"][package_name]["Status"] = "\033[1;32mJoined Roblox\033[0m"
    ...
    def bypass_thread():
        ...
        while True:
            ...
            try:
                ...
                if not result:
                    print("\033[1;31m[ ToiLaTu ] - Get Codex key failed. Retrying...\033[0m")
                    time.sleep(5)
                    continue
                    
                expiry_timestamp = result.get("expiry", 0)
                if not expiry_timestamp:
                    print("\033[1;31m[ ToiLaTu ] - Invalid expiry timestamp. Retrying...\033[0m")
                    time.sleep(5)
                    continue
                ...
                while codex_bypass_enabled:
                    ...
                    if time_left <= 0:
                        print("\033[1;33m[ ToiLaTu ] - Codex key expired. Restarting...\033[0m")
                        break
                        
                    formatted_time = Utilities.format_time_left(time_left)
                    sys.stdout.write(f"\r\033[1;32m[ ToiLaTu ] - Codex key expiry in: {formatted_time} ")
                    sys.stdout.flush()
                    time.sleep(1)
                ...
                print(f"\033[1;31m[ ToiLaTu ] - Error in bypass thread: {e}\033[0m")
                time.sleep(5)
...
class Runner:
    ...
    def launch_package_sequentially(server_links):
        ...
        for package_name, server_link in server_links:
            ...
            if user_id == "Unknown":
                print(f"\033[1;31m[ ToiLaTu ] - No UserID found for {package_name}, skipping...\033[0m")
                continue
        ...
        for index, (package_name, server_link) in enumerate(packages_to_launch):
            ...
            print(f"\033[1;32m[ ToiLaTu ] - Launching package {index + 1}/{total_packages}: {package_name}\033[0m")
            try:
                RobloxManager.launch_roblox(package_name, server_link)
                if globals()["check_exec_enable"] == "1":
                    ...
                    if len(detected_executors) > 0:
                        ...
                        print(f"\033[1;33m[ ToiLaTu ] - No executors detected for {package_name}\033[0m")
            except Exception as e:
    ...
    def force_rejoin(server_links, interval, stop_event):
        ...
        while not stop_event.is_set():
            if force_rejoin_interval != float('inf') and (time.time() - start_time >= force_rejoin_interval):
                print("\033[1;31m[ ToiLaTu ] - Force killing Roblox processes due to time limit.\033[0m")
                RobloxManager.kill_roblox_processes()
                start_time = time.time()
                print("\033[1;33m[ ToiLaTu ] - Waiting for 5 seconds before starting the rejoin process...\033[0m")
                time.sleep(5)
...
def check_activation_status():
    try:
        response = requests.get("https://raw.githubusercontent.com/caot60002/t/refs/heads/main/customize", timeout=5)
        response.raise_for_status()
        content = response.text.strip()
        if content == "true":
            print("\033[1;32m[ ToiLaTu ] - Activation status: Enabled. Proceeding with tool execution.\033[0m")
            return True
        elif content == "false":
            print("\033[1;31m[ ToiLaTu ] - Activation status: Disabled. Tool execution halted.\033[0m")
            return False
        else:
            print(f"\033[1;31m[ ToiLaTu ] - Invalid activation status received: {content}. Halting execution.\033[0m")
            Utilities.log_error(f"Invalid activation status: {content}")
            return False
    except requests.RequestException as e:
        print(f"\033[1;31m[ ToiLaTu ] - Error checking activation status: {e}\033[0m")
...
def main():
    ...
    if not check_activation_status():
        print("\033[1;31m[ ToiLaTu ] - Exiting due to activation status check failure.\033[0m")
        return
    ...
    if not globals().get("command_8_configured", False):
        globals()["check_exec_enable"] = "1"
        globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/caot60002/t/refs/heads/main/checkonl%2Btrack.lua"))()'
        config_file = os.path.join("ToiLaTu", "checkui.lua")
        try:
            os.makedirs("ToiLaTu", exist_ok=True)
            with open(config_file, "w") as f:
                f.write(globals()["lua_script_template"])
            print("\033[1;32m[ ToiLaTu ] - Default script saved to checkui.lua\033[0m")
        except Exception as e:
            print(f"\033[1;31m[ ToiLaTu ] - Error saving default script to {config_file}: {e}\033[0m")
            Utilities.log_error(f"Error saving default script to {config_file}: {e}")
        FileManager.save_config()

    if webhook_interval is None:
        print("\033[1;31m[ ToiLaTu ] - Webhook interval not set, disabled.\033[0m")
        webhook_interval = float('inf')
    if webhook_url and device_name and webhook_interval != float('inf'):
        WebhookManager.start_webhook_thread()
    else:
        print("\033[1;33m[ ToiLaTu ] - Webhook not configured or disabled.\033[0m")
    ...
    while True:
        ...
        setup_type = input("\033[1;93m[ ToiLaTu ] - Enter command: \033[0m")
        ...
        if setup_type == "1":
            try:
                ...
                if not globals()["accounts"]:
                    print("\033[1;31m[ ToiLaTu ] - No user IDs set up.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                if not server_links:
                    print("\033[1;31m[ ToiLaTu ] - No game ID or server link set up.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue

                force_rejoin_input = input("\033[1;93m[ ToiLaTu ] - Force rejoin interval (minutes, 'q' to skip): \033[0m")
                force_rejoin_interval = float('inf') if force_rejoin_input.lower() == 'q' else int(force_rejoin_input) * 60
                if force_rejoin_interval <= 0:
                    print("\033[1;31m[ ToiLaTu ] - Interval must be positive.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                ...
                if codex_bypass_active and codex_bypass_enabled:
                    print("\033[1;32m[ ToiLaTu ] - Codex bypass enabled.\033[0m")
            ...
            try:
                print("\033[1;32m[ ToiLaTu ] - Auto Setup User IDs from appStorage.json...\033[0m")
                packages = RobloxManager.get_roblox_packages()
                accounts = []
                ...
                for package_name in packages:
                    ...
                    try:
                        ...
                        if user_id and user_id != "-1":
                            ...
                            print(f"\033[96m[ ToiLaTu ] - Found UserId for {package_name}: {user_id}\033[0m")
                        else:
                            print(f"\033[1;31m[ ToiLaTu ] - UserId not found for {package_name}.\033[0m")
                    except Exception as e:
                        print(f"\033[1;31m[ ToiLaTu ] - Error reading file for {package_name}: {e}\033[0m")
                        Utilities.log_error(f"Error reading appStorage.json for {package_name}: {e}")

                if accounts:
                    FileManager.save_accounts(accounts)
                    print("\033[1;32m[ ToiLaTu ] - User IDs saved!\033[0m")
                else:
                    print("\033[1;31m[ ToiLaTu ] - No User IDs found.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue

                print("\033[93m[ ToiLaTu ] - Select game:\033[0m")
                games = [
                ...
                choice = input("\033[93m[ ToiLaTu ] - Enter choice: \033[0m").strip()
                game_ids = {
                ...
                if choice in game_ids:
                    ...
                    server_link = input("\033[93m[ ToiLaTu ] - Enter game ID or private server link: \033[0m")
                else:
                    print("\033[1;31m[ ToiLaTu ] - Invalid choice.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                ...
                if formatted_link:
                    ...
                    print("\033[1;32m[ ToiLaTu ] - Game ID or server link saved!\033[0m")
                else:
                    print("\033[1;31m[ ToiLaTu ] - Invalid server link.\033[0m")
            except Exception as e:
                print(f"\033[1;31m[ ToiLaTu ] - Error: {e}\033[0m")
                Utilities.log_error(f"Setup error: {e}")
                input("\033[1;32mPress Enter to return...\033[0m")
            ...
            try:
                ...
                config_choice = input("\033[1;93m[ ToiLaTu ] - Select check method (1-2, 'q' to keep default): \033[0m").strip()

                if config_choice.lower() == "q":
                    globals()["check_exec_enable"] = "1"
                    globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/caot60002/t/refs/heads/main/checkonl%2Btrack.lua"))()'
                    print("\033[1;32m[ ToiLaTu ] - Default set: Executor + ToiLaTu Check\033[0m")
                elif config_choice == "1":
                    globals()["check_exec_enable"] = "1"
                    globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/caot60002/t/refs/heads/main/checkonl%2Btrack.lua"))()'
                    print("\033[1;32m[ ToiLaTu ] - Set to Executor + ToiLaTu Check\033[0m")
                elif config_choice == "2":
                    globals()["check_exec_enable"] = "0"
                    globals()["lua_script_template"] = None
                    print("\033[1;36m[ ToiLaTu ] - Set to Online Check.\033[0m")
                else:
                    print("\033[1;31m[ ToiLaTu ] - Invalid choice. Keeping default.\033[0m")
                    globals()["check_exec_enable"] = "1"
                    globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/caot60002/t/refs/heads/main/checkonl%2Btrack.lua"))()'
                ...
                if globals()["lua_script_template"]:
                    try:
                        ...
                        with open(config_file, "w") as f:
                            f.write(globals()["lua_script_template"])
                        print(f"\033[1;36m[ ToiLaTu ] - Script saved to {config_file}\033[0m")
                    except Exception as e:
                        print(f"\033[1;31m[ ToiLaTu ] - Error saving script: {e}\033[0m")
                        Utilities.log_error(f"Error saving script to {config_file}: {e}")
                else:
                    if os.path.exists(config_file):
                        try:
                            os.remove(config_file)
                            print(f"\033[1;36m[ ToiLaTu ] - Removed {config_file} for Online Check.\033[0m")
                        except Exception as e:
                            print(f"\033[1;31m[ ToiLaTu ] - Error removing {config_file}: {e}\033[0m")
                            Utilities.log_error(f"Error removing {config_file}: {e}")

                globals()["command_8_configured"] = True

                FileManager.save_config()
                print("\033[1;32m[ ToiLaTu ] - Check method configuration saved.\033[0m")
            except Exception as e:
                print(f"\033[1;31m[ ToiLaTu ] - Error setting up check method: {e}\033[0m")
            ...
            if codex_bypass_enabled:
                codex_bypass_enabled = False
                print("\033[1;31m[ ToiLaTu ] - Codex bypass disabled.\033[0m")
            else:
                ...
                if codex_bypass_thread is None or not codex_bypass_thread.is_alive():
                    ...
                    print("\033[1;32m[ ToiLaTu ] - Codex bypass enabled and thread started.\033[0m")
                else:
                    print("\033[1;32m[ ToiLaTu ] - Codex bypass already running.\033[0m")
            FileManager.save_config()
            ...
            try:
                ...
                print(f"\033[1;32m[ ToiLaTu ] - Current package prefix: {current_prefix}\033[0m")
                new_prefix = input("\033[1;93m[ ToiLaTu ] - Enter new package prefix (or press Enter to keep current): \033[0m").strip()
                
                if new_prefix:
                    globals()["package_prefix"] = new_prefix
                    FileManager.save_config()
                    print(f"\033[1;32m[ ToiLaTu ] - Package prefix updated to: {new_prefix}\033[0m")
                else:
                    print(f"\033[1;33m[ ToiLaTu ] - Package prefix unchanged: {current_prefix}\033[0m")
            except Exception as e:
                print(f"\033[1;31m[ ToiLaTu ] - Error setting package prefix: {e}\033[0m")
            ...
            if not auto_android_id_enabled:
                android_id = input("\033[1;93m[ ToiLaTu ] - Enter Android ID to spam set: \033[0m").strip()
                if not android_id:
                    print("\033[1;31m[ ToiLaTu ] - Android ID cannot be empty.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                ...
                print("\033[1;32m[ ToiLaTu ] - Auto change Android ID enabled.\033[0m")
            else:
                auto_android_id_enabled = False
                print("\033[1;31m[ ToiLaTu ] - Auto change Android ID disabled.\033[0m")
            input("\033[1;32mPress Enter to return...\033[0m")
            continue
...
if __name__ == "__main__":
    try:
        ...
        print(f"\033[1;31m[ ToiLaTu ] - Error during initialization: {e}\033[0m")
