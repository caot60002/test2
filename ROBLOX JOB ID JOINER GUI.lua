...
if CoreGui.RobloxPromptGui.promptOverlay:WaitForChild("ErrorPrompt") then
       if CoreGui.RobloxPromptGui.promptOverlay.ErrorPrompt.MessageArea.ErrorFrame.ButtonArea:FindFirstChild("OkButton") then
           ...
           GuiService:SetCore("SendNotification", {Title = "ToiLaTu",Text = "Error, Invalid Job ID";})
       else
           GuiService:SetCore("SendNotification", {Title = "ToiLaTu",Text = "Successful, Joining Server";})  
       end
end
end)
...
GuiService:SetCore("SendNotification", {Title = "ToiLaTu",Text = "Copied Job ID to Your Clipboard";})
...
GuiService:SetCore("SendNotification", {Title = "ToiLaTu",Text = "Closing Gui";})
JobIDGui:Destroy()
end)